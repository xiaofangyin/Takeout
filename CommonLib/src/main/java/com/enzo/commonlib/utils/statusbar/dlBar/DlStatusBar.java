package com.enzo.commonlib.utils.statusbar.dlBar;
    ...
    public static void setColorForDrawerLayout(Activity activity, DrawerLayout drawerLayout,
        ...
        if (!(contentLayout instanceof LinearLayout) && contentLayout.getChildAt(1) != null) {
            contentLayout.getChildAt(1)
                    .setPadding(contentLayout.getPaddingLeft(), StatusBarUtils.getStatusBarHeight(activity) + contentLayout.getPaddingTop(),
