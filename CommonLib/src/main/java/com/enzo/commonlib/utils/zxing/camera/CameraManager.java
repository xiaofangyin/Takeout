...
package com.enzo.commonlib.utils.zxing.camera;
...
//      }
     ...
     */
    public Rect getFramingRect(boolean isBarCode) {
        ...
        if (isBarCode) {
            ...
            height = screenResolution.x * 4 / 10;
        } else {
            width = screenResolution.x * 6 / 10;
            height = screenResolution.x * 6 / 10;
        }
