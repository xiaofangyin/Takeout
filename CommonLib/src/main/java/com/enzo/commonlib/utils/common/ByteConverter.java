...
public class ByteConverter {
	...
	public static int toIntBigEn(byte[] byteArray4) {
		int intValue = 0;
		intValue |= byteArray4[0] & 0xFF;
		intValue <<= 8;
		intValue |= byteArray4[1] & 0xFF;
	...
	public static long toLongBigEn(byte[] byteArray8) {
		long longValue = 0L;
		longValue |= byteArray8[0] & 0xFF;
		longValue <<= 8;
		longValue |= byteArray8[1] & 0xFF;
	...
	public static byte[] toBytesBigEn(int intValue) {
		byte[] byteValue = new byte[4];
		byteValue[3] = (byte) (intValue & 0xFF);
		byteValue[2] = (byte) ((intValue & 0xFF00) >> 8);
		byteValue[1] = (byte) ((intValue & 0xFF0000) >> 16);
	...
	public static byte[] toBytesBigEn(long longValue) {
		byte[] byteValue = new byte[8];
		byteValue[7] = (byte) (int) (longValue & 0xFF);
		byteValue[6] = (byte) (int) ((longValue & 0xFF00) >> 8);
		byteValue[5] = (byte) (int) ((longValue & 0xFF0000) >> 16);
		byteValue[4] = (byte) (int) ((longValue & 0xFF000000) >> 24);
		byteValue[3] = (byte) (int) ((longValue & 0x0) >> 32);
		byteValue[2] = (byte) (int) ((longValue & 0x0) >> 40);
		byteValue[1] = (byte) (int) ((longValue & 0x0) >> 48);
		byteValue[0] = (byte) (int) ((longValue & 0x0) >> 56);
		return byteValue;
	}
