...
import com.enzo.commonlib.widget.banner.mzbanner.transformer.CoverModeTransformer;
import com.enzo.commonlib.widget.banner.mzbanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        MZPagerAdapter(List<T> datas, MZHolderCreator MZHolderCreator, boolean canLoop) {
            if (mDatas == null) {
        ...
        private View getView(int position, ViewGroup container) {
            ...
            MZViewHolder holder = mMZHolderCreator.createViewHolder();
            if (holder == null) {
