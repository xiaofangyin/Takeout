...
public class BarrageView extends ViewGroup implements IBarrageView {
    ...
    private BaseBarrageAdapter mAdapter;
    // 单行的高度
     ...
     * @param adapter 适配器
     */
    public void setAdapter(BaseBarrageAdapter adapter) {
    ...
    public void addBarrageItem(final View view) {
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                BarrageView.this.removeView(view);
                BaseBarrageAdapter.BarrageViewHolder holder = (BaseBarrageAdapter.BarrageViewHolder) view.getTag(R.id.barrage_view_holder);
