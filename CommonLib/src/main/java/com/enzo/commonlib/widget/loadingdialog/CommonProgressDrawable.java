 ...
 */
public class CommonProgressDrawable extends Drawable implements Animatable {
    ...
    private static final float CENTER_RADIUS = 12;//8.75f; //should add up to 10 when + stroke_width
    private static final float STROKE_WIDTH = 3;//2.5f;
    ...
    CommonProgressDrawable(Context context, View parent) {
        mParent = parent;
    ...
    //@android.support.v4.widget.MaterialProgressBar.ProgressDrawableSize
