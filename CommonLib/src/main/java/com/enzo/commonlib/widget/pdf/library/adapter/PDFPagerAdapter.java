 ...
 */
package com.enzo.commonlib.widget.pdf.library.adapter;
...
import com.enzo.commonlib.widget.pdf.library.util.EmptyClickListener;
...
public class PDFPagerAdapter extends BasePDFPagerAdapter
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View v = inflater.inflate(R.layout.pdf_view_pdf_page, container, false);
